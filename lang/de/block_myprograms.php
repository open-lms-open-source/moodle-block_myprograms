...
$string['error:cannotaccessprogram'] = 'Sie haben keinen Zugriff auf dieses Programm';
$string['error:coursemisconfigured'] = 'Der Kurs ist falsch konfiguriert';
$string['filterprograms'] = 'Meine Programme filtern';
$string['noprograms'] = 'Es sind keine Programminformationen vorhanden, die angezeigt werden können.';
$string['programdetail'] = 'Programmdetails';

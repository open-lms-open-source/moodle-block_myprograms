...
$string['error:cannotaccessprogram'] = 'ليس لديك حق الوصول إلى هذا البرنامج';
$string['error:coursemisconfigured'] = 'تم تكوين المقرر الدراسي بشكل غير صحيح';
$string['filterprograms'] = 'تصفية برامجي';
$string['noprograms'] = 'لا توجد معلومات برنامج لإظهارها.';
$string['programdetail'] = 'تفاصيل البرنامج';
...
$string['programstatuscompleted'] = 'مكتمل';
